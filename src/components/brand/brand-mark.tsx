...
export function BrandMark({ inverse = false }: { inverse?: boolean }) {
  return (
    <Link aria-label="SocialOreo home" className={`inline-flex items-center gap-2.5 font-display text-xl font-extrabold tracking-[-0.045em] ${inverse ? "text-white" : "text-[var(--social-ink)]"}`} href="/">
